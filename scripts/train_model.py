...
model.save('./app/models/RecoveryTracker/tea_health_model.h5')
joblib.dump(scaler, './app/models/RecoveryTracker/scaler.pkl')
joblib.dump(X_train.columns, './app/models/RecoveryTracker/feature_columns.pkl')
